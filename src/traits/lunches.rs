...
pub trait Obed {
    fn choose(self, epage: Edupage, number: i32);
    fn make_choice(self, epage: Edupage, choice_str: &str);
    fn sign_off(self, epage: Edupage);
}

pub trait Essen<ALACarte> {
    fn get_lunch(&self, date: NaiveDate) -> Result<Option<ALACarte>, Box<dyn Error>>;
}
...
impl<ALACarte> Essen<ALACarte> for Lunches {
    ...
    fn get_lunch(&self, date: NaiveDate) -> Result<Option<ALACarte>, Box<dyn Error>> {
        ...
        let amount_of_foods = lunch
            ...
            .and_then(|v| v.as_u64())
            .map(|v| v as u32);
        let chooseable_menus = lunch.get("choosableMenus");
